...
touch $projectName.Solution/$projectName/Models/Model.cs
cat >$projectName.Solution/$projectName/Models/Model.cs <<EOL
using System;
...
touch $projectName.Solution/$projectName.Tests/ModelTests/ModelTest.cs
cat >$projectName.Solution/$projectName.Tests/ModelTests/ModelTest.cs <<EOL
